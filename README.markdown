...
**Bonus** : For C++26 and later, the [ciede2000-constexpr.cpp](./ciede2000-constexpr.cpp) file provides a generically typed implementation that can be fully evaluated at compile time, and it includes rigorous tests.
